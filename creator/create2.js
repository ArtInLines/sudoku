...
let boardFile = JSON.parse(fs.readFileSync(filePath, { encoding: 'utf-8' }));
let board = boardFile.currentBoard;
let validSudokus = boardFile.sudokus;
const startingBoard = boardFile.startBoard;
...
function storeResult(i) {
	console.log(i);
	const data = { currentBoard: board, startBoard: startingBoard, sudokus: validSudokus };
